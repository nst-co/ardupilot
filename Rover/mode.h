...
public:
    ...
    virtual float crosstrack_error_integrator() const;
    virtual float crosstrack_distance_integrator() const;
...
protected:
    ...
    void calc_steering_from_turn_rate(float turn_rate, bool reverse = false);
    ...
    void calc_throttle_waypoint(float target_speed);
