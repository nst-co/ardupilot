...
public:
    ...
    virtual float crosstrack_distance_integrator(void) const = 0;
    ...
    virtual void update_waypoint(const class Location &prev_WP, const class Location &next_WP, float dist_min = 0.0f, float curvature_radius = 0.0f) = 0;
    ...
    virtual void set_param_ratio(float rpm_accel, float rpm_decel, float reduction_ratio) = 0;
