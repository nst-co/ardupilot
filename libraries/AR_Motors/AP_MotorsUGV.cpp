...
const AP_Param::GroupInfo AP_MotorsUGV::var_info[] = {
    ...
    // @Range: 0.1 5.0
    // @User: Advanced
    AP_GROUPINFO("TREAD", 17, AP_MotorsUGV, _tread, 0.6f),
    ...
    // @Range: 0.1 5.0
    // @User: Advanced
    AP_GROUPINFO("WHEELBASE", 18, AP_MotorsUGV, _wheelbase, 0.6f),
    ...
    // @Increment: 1
    // @User: Advanced
    AP_GROUPINFO("SLEWRATEDOWN", 19, AP_MotorsUGV, _slew_rate_down, 100),
...
bool AP_MotorsUGV::have_skid_steering() const
{
    if ((SRV_Channels::function_assigned(SRV_Channel::k_throttleLeft) &&
        SRV_Channels::function_assigned(SRV_Channel::k_throttleRight)) || is_omni()) {
