...
public:
    ...
    float get_steering_out_rate(float desired_rate, bool motor_limit_left, bool motor_limit_right, float dt, bool reverse = false);
...
private:
    ...
    AC_PID   _steer_backward_rate_pid; // steering backward rate controller
